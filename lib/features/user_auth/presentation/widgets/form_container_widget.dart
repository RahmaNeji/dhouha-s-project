    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: _getPrefixIcon(), // Appel de la fonction pour obtenir l'icône préfixe
          suffixIcon: _getSuffixIcon(), // Appel de la fonction pour obtenir l'icône suffixe
        ),
      ),
    );
  }
